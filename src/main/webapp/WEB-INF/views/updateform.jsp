        ...
        <form:form action="updateacustomer" method="post" >
            <div class="customer-form">
                <div class="left">
                    ...
                    <input type="number" name="organizationCode" id="organizationCode" disabled><br>

                    <label class="required" for="groupCode">Group Code</label>
                    <input type="text" name="groupCode" id="groupCode" disabled><br>
                ...
                <div class="right">
                    ...
                    <input type="text" name="organizationName" id="organizationName" disabled><br>

                    <label for="groupName">Group Name</label>
                    <input type="text" name="groupName" id="groupName" disabled><br>
